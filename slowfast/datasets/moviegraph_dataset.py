...
class MovieGraph(torch.utils.data.Dataset):
    ...
    def _load_data(self, cfg):
        ...
        ) = moviegraph_helper.load_image_lists(cfg, is_train=(self._split == "train"))

        # Loading annotations for boxes and labels.
        boxes_and_labels = moviegraph_helper.load_boxes_and_labels(
        ...
        self._num_boxes_used = moviegraph_helper.get_num_boxes_used(
    ...
    def __getitem__(self, idx):
        ...
        #     center_idx,
        #     # self._seq_len // 2,
        #     #ava数据集里全都是固定长度的，这里是变长的视频
        #     half_len=(len(self._image_paths[video_idx]) * self._sample_rate) // 2,
        #     self._sample_rate,
        ...
        imgs = utils.retry_load_images(
            image_paths, backend=self.cfg.MOVIEGRAPH.IMG_PROC_BACKEND
        )
        if self.cfg.MOVIEGRAPH.IMG_PROC_BACKEND == "pytorch":
            # T H W C -> T C H W.
